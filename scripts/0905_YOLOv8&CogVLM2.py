...
if __name__ == "__main__":
    ...
    test_image = "/home/zy/1.Code/new_water_meter_recognition/data/yolo_error_cogvlm_correct/911083004006_20240411.jpg"
    low_conf_save_dir = "/home/zy/1.Code/new_water_meter_recognition/confidence/low_conf_images"
    
    # 处理图片
    final_reading = process_image(test_image, yolo_model, low_conf_save_dir)

    
    print(f"最终的水表读数结果: {final_reading}")
